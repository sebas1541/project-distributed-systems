...
4. CREATE A SMART DESCRIPTION: Remove redundant time/date info from description and add helpful context instead
...
3. EXTRACT the date/time if mentioned:
   ...
   - "day after tomorrow" = add 2 days to current date
...
5. CREATE A SMART DESCRIPTION (CRITICAL):
   ...
   - Shopping: "Check inventory first", "Bring reusable bags"
   - Appointments: "Arrive early", "Bring documents"
   - Calls: "Prepare talking points"
   - Exercise: "Prepare workout clothes"
   - Meetings: "Review agenda", "Prepare materials"
   - Errands: "Bring necessary items"
   - Work tasks: "Double-check before submitting"
